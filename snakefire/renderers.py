    ...
    MESSAGES = {
        "alert": """
            <div class="item notify">
                <strong class="author">{user}</strong> <small class="time text-muted">at {time}</small>
        ...
        "image": """
            <div class="item">
                <div>
                    <a href="{url}">
                        <img src="data:image/{type};base64,{data}" title="{name}" {attribs}>
                    </a>
                </div>
            </div>
        """,
        "image_url": """
            <div class="item">
                <div>
                    <a href="{url}">
                        <img src="{url}" title="{name}" {attribs}>
                    </a>
                </div>
            </div>
        """,
        "join": u'<div class="item joined text-muted"><small>{user} joined {room}</small></div>',
        "leave": u'<div class="item left text-muted"><small>{user} has left {room}</small></div>',
        "message_self": """
            <div class="item">
                <strong class="author">{user}</strong> <small class="time text-muted">at {time}</small>
                <blockquote class="message self">
                    {message}
                </blockquote>
            </div>
        """,
        "no_time_message_self": """
            <div class="item">
                <strong class="author">{user}</strong>
                <blockquote class="message self">
                    {message}
                </blockquote>
            </div>
